...
# ---------------------------------------------------------
crossref_path = Path(r"data\IUCN\2026_01\working\crossref_full_harvestIds.csv")
category_path = Path(r"data\IUCN\2026_01\working\RL_assessments_2026_01_CR.csv")
output_path   = Path("data/IUCN/2026_01/out/RL_assessments_2026_01_CR.csv")
# ---------------------------------------------------------
