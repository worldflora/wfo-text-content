...
# Load your file
df = pd.read_csv(r"data\Royal Botanic Garden Edinburgh\Begonia\work\MissingDoiRefs.csv", sep=",", encoding="utf-8")
...
with open(r"data\Royal Botanic Garden Edinburgh\script\publications_with_doi2.tsv", "w", newline="", encoding="utf-8") as out:
    writer = csv.writer(out, delimiter="\t")

    # Write header
    writer.writerow(["bibliographicCitation", "DOI"])
