...
# Load your file
df = pd.read_csv("data\\New_York_Botanic_Garden\\Brittonia\\work\\unique_refs_2.csv", sep=",", encoding="utf-8")
...
with open("data\\New_York_Botanic_Garden\\Brittonia\\work\\publications_with_doi2.tsv", "w", newline="", encoding="utf-8") as out:
